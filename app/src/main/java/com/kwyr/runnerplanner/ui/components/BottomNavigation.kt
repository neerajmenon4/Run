...
fun BottomNavigation(
    ...
    NavigationBar(
        ...
        val planLabel = if (selectedMode == ActivityMode.BIKING) "Rides" else stringResource(R.string.nav_plan)
            ...
            NavigationBarItem(
                ...
                icon = {
                    when (item.iconContent) {
                        ...
                        "plan" -> if (selectedMode == ActivityMode.BIKING) {
                            BikeIcon(color = if (isSelected) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.tertiary)
                        } else {
                            CalendarIcon(color = if (isSelected) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.tertiary)
                        }
